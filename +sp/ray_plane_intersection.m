%--------------------------------------------------------------------------
%   [cross_point,R] = ray_plane_intersection(start_points,Vector,plane)
%--------------------------------------------------------------------------
%   功能:
%	计算射线与平面的交点以及射线的距离
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
%   例子：
%   [points,R] = ray_plane_intersection([0 0 0],[1 1 1],[3 4 5 6])
%--------------------------------------------------------------------------
function [cross_point,R] = ray_plane_intersection(start_points,Vector,plane)
